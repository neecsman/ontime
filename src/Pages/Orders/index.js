  ...
  return (
    <section className={style.section}>
      <div className="flex justify-between mb-8">
        <h1 className="text-black text-5xl font-semibold">Заказы</h1>
      </div>
              ...
              <>
                {filteredOrders.length ? (
                      ...
                      <>
                        {filteredOrders.map((item) => {
                          return (
                            <div
                              key={item.order_id}
                              className="flex flex-col w-full bg-white border border-gray shadow rounded-xl p-4 font-sans my-2"
                            >
                              ...
                              <div className="flex justify-between items-center mt-5">
                                {item.status === "cancеled" && <b>Отменен</b>}
                                {item.status === "completed" && <b>Завершен</b>}
                                {item.status === "active" && <b>Активен</b>}
                  ...
                  <div className="flex flex-col justify-center items-center h-[30vh]">
                    <span className="text-black text-3xl font-bold mb-12">
